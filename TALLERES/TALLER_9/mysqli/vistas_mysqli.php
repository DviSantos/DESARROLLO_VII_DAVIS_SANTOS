...
function mostrarProctuctosBajoStock($conn) {
...
function mostrarHistorialVentas($conn) {
...
function mostrarTendencias($conn) {
...
mostrarProctuctosBajoStock($conn);
mostrarHistorialVentas($conn);
mostrarRendimientoCategorias($conn);
mostrarTendencias($conn);
mysqli_close($conn);
