...
$misAmigos = ["Pepe pollo","Antonio miguel","juan"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Pana miguel","Toby"); // Reemplaza las comillas vacías con los nombres de tus amigos
