...
$miArray = ["Perro","gato","zorro"]; // Reemplaza esto con tu propio array
$miString = "Sebastian"; // Reemplaza esto con tu propio string
$miNumero = 70; // Reemplaza esto con tu propio número
