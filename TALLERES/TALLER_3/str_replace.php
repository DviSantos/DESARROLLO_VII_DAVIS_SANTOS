...
$miFrase = "Victor le dice a joel: Aprendi PHP. De repente Joel le dice a victor no conpila el PHP. Sin embargo Victor le responde a Joel: PHP no tiene compilador."; // Reemplaza esto con tu frase
